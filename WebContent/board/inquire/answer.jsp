...
<body>
	<div id="content">
		<h3>답글 쓰기</h3>
		<form name="fm" method="post" action="InquireAnswerArticle.action">
			...
			<table>
				...
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" size="80"  value="[Re:]<s:property value='article.title'/> "/>
			...
			<div align="center">
				...
				<input type="button" onclick="location.href='InquireView.action?no=<s:property value="no"/>&page=<s:property value="page" />&r=n' " value="취 소" />
			</div>
		</form>
	</div>
</body>
