...
<body>
	<div id="content">
		<h3>새 글 쓰기</h3>
		<form name="fm" method="post" action="InquireWriteArticle.action">
			<table>
				<tr>
					<th width="60">작성자</th>
			...
			<div align="center">
				...
				<input type="button" onclick="location.href='InquireIndex.action?page=<s:property value="#parameters.page" />'" value="취 소" />
			</div>
		</form>
	</div>
</body>
