...
<body>
	<div id="content">
		<h3>새글 쓰기</h3>
		<form name="fm" action="NoticeWrite.action" method="post">
			<table>
				<tr>
					<th width="60">작성자</th>
				...
				<tr>
					<th>내용</th>
					<td><textarea rows="15" cols="80" name="notice" ></textarea></td>
				</tr>
			</table>
			<br />
			<div align="center">
				<input type="submit" onclick="return checkForm()" value="확 인" />&nbsp;&nbsp;
				<input type="button" onclick="location.href='NoticeIndex.action?page=<s:property value="#parameters.page"/>'" value="취 소" />
			</div>
		</form>
	</div>
</body>
