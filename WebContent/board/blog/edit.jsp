...
<body>
	<div id="content">
		<h3>글 수정</h3>
		<form name="fm" method="post" action="BlogEditArticle.action">
			...
			<table>
				...
				<tr>
					<th>내용</th>
					<td>
						<textarea rows="15" cols="80" name="content"><s:property value="article.content"/></textarea>
					</td>
				</tr>
			</table>
			<br />
			<div align="center">
				...
				<input type="button" onclick="location.href='BlogView.action?no=<s:property value="no"/>&page=<s:property value="page"/>&r=n'" value="취 소" />
			</div>
		</form>
	</div>
</body>
